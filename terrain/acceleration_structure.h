...
public:
    ...
    bool intersects(const glm::vec3 & start, const glm::vec3 & direction) const;
...
public:
    Base();
    virtual ~Base();
    std::vector<AccelerationSphere> get_intersecting_spheres(const glm::vec3 & start, const glm::vec3 & direction);
...
private:
    ...
    std::vector<AccelerationSphere> get_intersecting_spheres(AccelerationTree & parent, const glm::vec3 & start, const glm::vec3 & direction);
